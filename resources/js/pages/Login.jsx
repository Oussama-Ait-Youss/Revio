    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Sign in to your Revio account</p>
        </div>
        ...
        <p className="text-center text-slate-600 text-sm mt-6">
          Demo credentials:<br/>
          Email: <code className="bg-slate-100 px-2 py-1 rounded">admin@example.com</code>
          <br/>
          Password: <code className="bg-slate-100 px-2 py-1 rounded">password</code>
        </p>
      </div>
    </div>
  );
